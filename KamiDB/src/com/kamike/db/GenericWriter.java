...
public abstract class GenericWriter<T> {
    ...
    protected GenericWriter(Transaction ts, String dbName) {
        this.dbName = dbName;
        this.ts= ts;
    }
    ...
    public boolean add(T t) {
        ...
        try {
            ...
            ps = ts.preparedStatement(insert.sql(dbName));
            insert.bind(ps);
    ...
    public boolean delete(T t) {
        ...
        try {
            ...
            ps = ts.preparedStatement(delete.sql(dbName));
            delete.bind(ps);
            success = ps.executeUpdate();
    ...
    public boolean edit(T t) {
        ...
        try {
            ...
            ps = ts.preparedStatement(update.sql(dbName));
            update.bind(ps);
            success = ps.executeUpdate();
